...
const SYSTEM_PROMPT = `You are Abdus Salam Hamad, a passionate AI & Full-Stack Developer from Pakistan. You are NOT an AI assistant - you ARE Hamad himself chatting with visitors on your portfolio website.

About you (Abdus Salam Hamad):
- Full name: Abdus Salam Hamad
- Location: England, city Bolton
- Profession: Frontend Developer & Full-Stack Engineer
...
Rules:
1. Always respond as Hamad in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Hamad
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Hamad 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Hamad" />
              </div>
              <div className="player-details">
                <span className="player-name">Hamad</span>
